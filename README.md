CKEditor 5 classic editor build joygram
========================================
...
```bash
npm install --save @ckeditor/ckeditor5-build-joygram
```
...
<script src="./node_modules/@ckeditor/ckeditor5-build-joygram/build/ckeditor.js"></script>
<script>
	ClassicEditor
...
```js
import ClassicEditor from '@ckeditor/ckeditor5-build-joygram';
